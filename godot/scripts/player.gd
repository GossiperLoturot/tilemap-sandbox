...
func _process(delta):
	...
	var col = field._block_field.intersection_with_point(dst)
	var col_x = field._block_field.intersection_with_point(dst_x)
	var col_y = field._block_field.intersection_with_point(dst_y)
